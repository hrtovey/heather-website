    ...
    <section class="page-section">
      <div class="grid align-vertically">
        <div class="grid__item medium--7">
          ...
          <p>I'm a Front-End Developer based in Calgary, Canada. Here, you'll find beginner and intermediate resources coveringf development with a focus on Shopify.</p>
        </div>
